...
\section{Subsets}
\label{sec:org232e10e}
\begin{itemize}
\item Every Element of A is also in B = A \subseteq B\\
\end{itemize}
\subsubsection{Example 1}
\label{sec:org5273b27}
A = \{1, 3\}\\
B = \{1, 3, 4, 6\}\\
A \subseteq B\\
\subsubsection{Example 2}
\label{sec:orgb374d33}
A = \{1, 8\}\\
B = \{1, 3, 4, 6\}\\
A \nsubseteq B\\
...
\label{sec:org76f5992}
\subsubsection{The converse statement}
\label{sec:org89bcca7}
