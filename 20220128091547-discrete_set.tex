...
\section{Subsets}
\label{sec:orgf4e4adf}
\begin{itemize}
\item Every Element of A is also in B = A \subseteq B\\
\end{itemize}
\subsubsection{Example 1}
\label{sec:orgbf5e72f}
A = \{1, 3\}\\
B = \{1, 3, 4, 6\}\\
A \subseteq B\\
\subsubsection{Example 2}
\label{sec:org728ba8c}
A = \{1, 8\}\\
B = \{1, 3, 4, 6\}\\
A \nsubseteq B\\
...
\label{sec:org57f6cea}
\subsubsection{The converse statement}
\label{sec:orga2b8e91}
