...
\section{Subsets}
\label{sec:org072c0f0}
\begin{itemize}
\item Every Element of A is also in B = A \subseteq B\\
\end{itemize}
\subsubsection{Example 1}
\label{sec:orgac2a803}
A = \{1, 3\}\\
B = \{1, 3, 4, 6\}\\
A \subseteq B\\
\subsubsection{Example 2}
\label{sec:org93e4999}
A = \{1, 8\}\\
B = \{1, 3, 4, 6\}\\
A \nsubseteq B\\
...
\label{sec:org38a0ea6}
\subsubsection{The converse statement}
\label{sec:orgf905efd}
